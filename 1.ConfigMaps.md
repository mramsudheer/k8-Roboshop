...
&emsp;•&emsp;Any command you run without `-n` will execute inside whatever namespace this command prints out.<br>
**Switch your active namespace permanently (The Native Way)**
...
```
*What happens now:* If you run kubectl create configmap `my-config --from-file=app.properties` right after this, Linux automatically routes it to `my-namespace`.<br>
